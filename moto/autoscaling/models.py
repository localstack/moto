...
class FakeAutoScalingGroup(CloudFormationModel):
    def __init__(
        ...
        self.service_linked_role = f"arn:{get_partition(self.region)}:iam::{self.account_id}:role/aws-service-role/autoscaling.amazonaws.com/AWSServiceRoleForAutoScaling"
